...
public class AllStockItemsAdapter extends RecyclerView.Adapter<AllStockItemsAdapter.MyViewHolder>{
    ...
    public AllStockItemsAdapter(ArrayList<StockItem>myDataset){
        stockItemsFromDb =myDataset;
    }
    @Override
    public AllStockItemsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        AllStockItemsAdapter.MyViewHolder viewHolder=new AllStockItemsAdapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AllStockItemsAdapter.MyViewHolder holder, int position) {
