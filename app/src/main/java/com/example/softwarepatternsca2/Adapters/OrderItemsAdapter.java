...
import com.example.softwarepatternsca2.CustomerFeatures.SelectedPreviousItem;
...
public class OrderItemsAdapter extends RecyclerView.Adapter<OrderItemsAdapter.MyViewHolder>{
    ...
    public OrderItemsAdapter(ArrayList<StockItem>myDataset){
    ...
    public OrderItemsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        OrderItemsAdapter.MyViewHolder viewHolder=new OrderItemsAdapter.MyViewHolder(itemView);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull OrderItemsAdapter.MyViewHolder holder, int position) {
        ...
        holder.txtView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(v.getContext(), SelectedPreviousItem.class);
